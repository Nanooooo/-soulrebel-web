  ...
  <body>
    ...
    <main>
        ...
        <div class="card-deck row p-5 bg-cornsilk height-550  ml-1 mr-1">
         ...
         <div class="card-deck row p-5 bg-cornsilk height-550  ml-1 mr-1">
          <div class="card">
             <img class="card-img-top" src="assets/images/remeras/coraje.jpg" alt="Card image cap">
             <div class="card-body bg-cornsilk">
              <h5 class="card-title color-texto-negro text-center font-weight-bold ">REMERA "CORAJE"</h5>
              <p class="card-text color-texto-negro text-center ">$850.</p>
         ...
         <div class="card-deck row p-5 bg-cornsilk height-550  ml-1 mr-1">
          <div class="card">
             <img class="card-img-top" src="assets/images/remeras/loco.jpg" alt="Card image cap">
             <div class="card-body bg-cornsilk">
              <h5 class="card-title color-texto-negro text-center font-weight-bold ">REMERA "FUMETA"</h5>
              <p class="card-text color-texto-negro text-center ">$850.</p>
              <button type="button" class=" d-block mx-auto  btn btn-dark">Agregar al carrito</button>
            </div>
          </div>
          <div class="card">
            <img class="card-img-top" src="assets/images/remeras/kanguro2.jpg" alt="Card image cap">
            <div class="card-body bg-cornsilk">
              <h5 class="card-title color-texto-negro text-center  font-weight-bold ">   REMERA "KANGURO"</h5>
              <p class="card-text color-texto-negro text-center ">$850.</p>
              <button type="button" class=" d-block mx-auto  btn btn-dark">Agregar al carrito</button>
            </div>
          </div>
         <div class="card">
            <img class="card-img-top" src="assets/images/remeras/mono.jpg" alt="Card image cap">
            <div class="card-body bg-cornsilk">
             <h5 class="card-title color-texto-negro text-center font-weight-bold ">REMERA "MONKEY"</h5>
             <p class="card-text color-texto-negro text-center ">$850.</p>
             <button type="button" class=" d-block mx-auto  btn btn-dark">Agregar al carrito</button>
            </div>
         </div>
         ...
         <section class="paginacion">
           <ul>
             <li><a href="remeras1.php">1</a></li>
             <li><a href="remeras2.php">2</a></li>
             <li><a href="remeras3.php">3</a></li>  
           </ul>
         </section>
